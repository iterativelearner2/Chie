...
namespace Llama
{
	public class LlamaClient
	{
		...
		public async Task Connect()
		{
			...
			ProcessSettings processSettings = new(this._settings.MainPath)
			{
				...
				StdOutWrite = (s, o) =>
				{
					...
					if (o.Contains('\r') && this.Connected && this._settings.ReturnOnNewLine)
					{
		...
		private static string GenerateParameters(LlamaSettings settings)
		{
			...
			if (settings.RepeatLastN.HasValue)
			{
				AddArgument("--repeat_last_n", $"{settings.RepeatLastN}");
			}
